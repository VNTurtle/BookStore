...
function add_Product(event) {
    ...
    $.ajax({
        type: 'POST',
        url: 'controller/add_product.php', // Đường dẫn xử lý formId (thay thế 'formId' bằng giá trị thực)
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
            console.log(response);
            window.location.href = 'index.php?src=admin/product/product_detail_admin&id='+ response;
