...
function submitForm(formId) {
    ...
    $.ajax({
        type: 'POST',
        url: 'controller/add_'+formId+'.php', // Đường dẫn xử lý form
        data: formData,
...
function update_Product(event) {
    ...
    $.ajax({
        type: 'POST',
        url: 'controller/update_product.php', // Đường dẫn xử lý formId (thay thế 'formId' bằng giá trị thực)
        data: formData,
        success: function(response) {
            window.location.href = 'index.php?src=admin/product/product_detail_admin&id='+ IdBook;
