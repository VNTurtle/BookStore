...
$query_count = "SELECT COUNT(*)as sl FROM publisher";
            ...
            <div class="card-datatable ">
                ...
                <div class="row mx-2">
                    <div class="col-sm-12 col-md-6 shows-stt">
                        <div class="data-info">Hiển thị từ <?php echo $offset + 1 ?> đến <?php echo $offset + count($lst_size) ?> của <?php echo $total_items ?> hóa đơn</div>
                    </div>
                        ...
                        <nav class="page-book" aria-label="Page navigation example" style="margin-top: 12px;">
                            <ul class="pagination">
                                <?php if ($current_page > 1) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/size/lst_size&page=<?php echo $current_page - 1 ?>" aria-label="Previous">
                                ...
                                if ($current_page > ($adjacents + 1)) {
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/size/lst_size&page=1">1</a></li>';
                                ...
                                for ($i = $start; $i <= $end; $i++) {
                                    if ($i == $current_page) {
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/size/lst_size&page=' . $i . '">' . $i . '</a></li>';
                                    }
                                }
                                ...
                                if ($current_page < ($total_pages - $adjacents)) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/size/lst_size&page=' . $total_pages . '">' . $total_pages . '</a></li>';
                                }

                                if ($current_page < $total_pages) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/size/lst_size&page=<?php echo $current_page + 1 ?>" aria-label="Next">
