                    ...
                    <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                        <div class="me-5 ms-n2 pe-5">
                            <div class="dataTables_filter">
                                <label>
                                    <input type="search" class="form-control" placeholder="Search Account" aria-controls="DataTables_Table_0">
                                </label>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="odd">
                                    ...
                                    <td>
                                        <label>
                                            <input class="toggle-checkbox" type="checkbox" data-role-id="<?php echo $lst['RoleId']; ?>" <?php echo ($lst['RoleId'] == 1) ? 'checked' : ''; ?>>
