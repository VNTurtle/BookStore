                                ...
                                <td>
                                    <div class="d-inline-block text-nowrap">
                                        <button class="btn btn-sm btn-icon">
                                            <a href="index.php?src=admin/product/edit_product&id=<?php echo $lst['Id'] ?>">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                        </button>
                                        <button class="btn btn-sm btn-icon">
                                            <a href="index.php?src=admin/product/product_detail_admin&id=<?php echo $lst['Id'] ?>">
                        ...
                        <nav class="page-book" aria-label="Page navigation example" style="margin-top: 12px;">
                            <ul class="pagination">
                                <?php if ($current_page > 1) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/product/lst_product_admin&page=<?php echo $current_page - 1 ?>" aria-label="Previous">
                                ...
                                if ($current_page > ($adjacents + 1)) {
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/product/lst_product_admin&page=1">1</a></li>';
                                ...
                                for ($i = $start; $i <= $end; $i++) {
                                    if ($i == $current_page) {
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/product/lst_product_admin&page=' . $i . '">' . $i . '</a></li>';
                                    }
                                }
                                ...
                                if ($current_page < ($total_pages - $adjacents)) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/product/lst_product_admin&page=' . $total_pages . '">' . $total_pages . '</a></li>';
                                }

                                if ($current_page < $total_pages) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/product/lst_product_admin&page=<?php echo $current_page + 1 ?>" aria-label="Next">
