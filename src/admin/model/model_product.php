...
$adjacents = 2;
$lst_model = Product::getProductBySL($offset, $items_per_page);
?>

<link rel="stylesheet" href="assets/css/model_product.css">
            ...
            <div class="card-datatable ">
                                ...
                                <td>
                                    <div class="d-inline-block text-nowrap">
                                        <button class="btn btn-sm btn-icon">
                                            <a href="index.php?src=admin/model/edit_model_product&id=<?php echo $lst['Id']; ?>">
                                                <i class="bx bx-edit"></i>
                                            </a>                                           
                                        </button>
                                        <button class="btn btn-sm btn-icon">
                                            <a href="index.php?src=admin/model/model_detail_product&id=<?php echo $lst['Id']; ?>">
                ...
                <div class="row mx-2">
                    <div class="col-sm-12 col-md-6 shows-stt">
                        <div class="data-info">Hiển thị từ <?php echo $offset + 1 ?> đến <?php echo $offset + count($lst_model) ?> của <?php echo $total_items ?> sản phẩm</div>
                    </div>
                        ...
                        <nav class="page-book" aria-label="Page navigation example" style="margin-top: 12px;">
                            <ul class="pagination">
                                <?php if ($current_page > 1) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/model/model_product&page=<?php echo $current_page - 1 ?>" aria-label="Previous">
                                ...
                                if ($current_page > ($adjacents + 1)) {
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/model/model_product&page=1">1</a></li>';
                                ...
                                for ($i = $start; $i <= $end; $i++) {
                                    if ($i == $current_page) {
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/model/model_product&page=' . $i . '">' . $i . '</a></li>';
                                    }
                                }
                                ...
                                if ($current_page < ($total_pages - $adjacents)) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/model/model_product&page=' . $total_pages . '">' . $total_pages . '</a></li>';
                                }

                                if ($current_page < $total_pages) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/model/model_product&page=<?php echo $current_page + 1 ?>" aria-label="Next">
