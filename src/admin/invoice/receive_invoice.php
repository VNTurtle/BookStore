...
$invoice = Invoice::getInvoicebyOrStatus(4, $offset, $items_per_page);
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Hóa Đơn /</span> Danh Sách Hóa Đơn Đã Nhận Hàng
        </h4>
        <div class="card">
                        ...
                        <nav class="page-book" aria-label="Page navigation example" style="margin-top: 12px;">
                            <ul class="pagination">
                                <?php if ($current_page > 1) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/invoice/receive_invoice&page=<?php echo $current_page - 1 ?>" aria-label="Previous">
                                ...
                                if ($current_page > ($adjacents + 1)) {
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/invoice/receive_invoice&page=1">1</a></li>';
                                ...
                                for ($i = $start; $i <= $end; $i++) {
                                    if ($i == $current_page) {
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/invoice/receive_invoice&page=' . $i . '">' . $i . '</a></li>';
                                    }
                                }
                                ...
                                if ($current_page < ($total_pages - $adjacents)) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="index.php?src=admin/invoice/receive_invoice&page=' . $total_pages . '">' . $total_pages . '</a></li>';
                                }

                                if ($current_page < $total_pages) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?src=admin/invoice/receive_invoice&page=<?php echo $current_page + 1 ?>" aria-label="Next">
